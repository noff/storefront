...
SimpleForm.setup do |config|
  ...
  # Зелёная «is-valid» подсветка убрана: после неудачного входа Devise рендерит
  # форму без ошибок на поле, и корректный email помечался галочкой — выглядело как баг.
